...
%% advanceprobability.m
%
%uses the score as a probabilistic to determine the next generation
%
%step in time

function An = advanceprobability(S,A)
...
for j=2: N-2,
    ...
    randij = (S(i,j)^10)*rand;
    
    Randmax = (Amax^10)*rand;
    
    
    if randij < Randmax,	% if alive but 
